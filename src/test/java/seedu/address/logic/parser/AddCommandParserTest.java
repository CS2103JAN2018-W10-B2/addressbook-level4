...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
                ...
                .withTimeZone(VALID_TIMEZONE_BOB).withComment(VALID_COMMENT_BOB).withTags(VALID_TAG_FRIEND).build();
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Person expectedPerson = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
                ...
                .withTimeZone(VALID_TIMEZONE_AMY).withComment(VALID_COMMENT_AMY).withTags().build();
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TIMEZONE_DESC_BOB  + COMMENT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
